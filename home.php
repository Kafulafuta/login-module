            		...
            		<div class="form-box">
            			<div class="form-tab">
	            			<ul class="nav nav-pills nav-fill" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link active" id="abbank" data-toggle="tab" href="bank" role="tab" aria-controls="an bank" aria-selected="true" style="color: #0000ff;">Admin Login</a>
							    </li>
							</ul>
							    ...
							    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
							    	<form action="home.php" method="post">
							    		...
							    		<div class="form-footer">
											...
											<a href="register.php" class="forgot-link"></a>
							    		</div><!-- End .form-footer -->
							    	</form>
